...
public class MyLogger{
    ...
    /*DEBUG_VALUE=4 [Print to stdout everytime a constructor is called]
      DEBUG_VALUE=3 [Print to stdout everytime a threads run() method is called]
      DEBUG_VALUE=2 [Print to stdout everytime we write to output file]
      DEBUG_VALUE=1 [Print to stdout everytime we have a System.out call]
    ...
    */
	...
	if (levelIn == debugLevel)
		if(debugLevel != DebugLevel.RELEASE)
